...
public class Fixture {
	...
	public static IOSimulator creaSimulazionePartitaEGiocaEasy(List<String> comandiDaLeggere) throws FileNotFoundException, FormatoFileNonValidoException {
	...
	public static IOSimulator creaSimulazionePartitaEGiocaHard(List<String> comandiDaLeggere) throws FileNotFoundException, FormatoFileNonValidoException {
		IOSimulator io = new IOSimulator(comandiDaLeggere);
	...
	public static IOSimulator creaSimulazionePartitaEGiocaMonolocale(List<String> comandiDaLeggere) throws FileNotFoundException, FormatoFileNonValidoException {
		IOSimulator io = new IOSimulator(comandiDaLeggere);
	...
	public static IOSimulator creaSimulazionePartitaEGiocaBilocale(List<String> comandiDaLeggere) throws FileNotFoundException, FormatoFileNonValidoException {
		IOSimulator io = new IOSimulator(comandiDaLeggere);
	...
	public static IOSimulator creaSimulazionePartitaEGiocaTrilocale(List<String> comandiDaLeggere) throws FileNotFoundException, FormatoFileNonValidoException {
		IOSimulator io = new IOSimulator(comandiDaLeggere);
